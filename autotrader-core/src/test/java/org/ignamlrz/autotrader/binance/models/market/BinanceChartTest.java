...
class BinanceChartTest {
    ...
    void testConversion(String errMsg, String json) throws JsonProcessingException {
        BinanceChart chart = TestUtils.buildJSON(json, BinanceChart.class, errMsg);
        ...
        if (Optional.ofNullable(chart).isPresent()) {
            ...
            // ...check deletion
            assertTrue(chart.delete(0L));
            assertTrue(chart.delete(1499040060000L));
            assertTrue(chart.delete(6000000000000L));
        }
    }
